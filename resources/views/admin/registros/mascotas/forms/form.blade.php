<div class="card-body ">
    <div class="row g-2">
        ...
        <div class="col-md-4 col-sm-12 col-xl-4">
            <div class="mb-2">
                {!! Form::label('Propietario', null ) !!}
                {!! Form::select('propietario', ['L' => 'Large', 'S' => 'Small'], null, ['class' => 'form-control'], ['placeholder' => 'Seleccione un tipo de identificacion']) !!}
                @error('propietario')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
    ...
    <div class="row g-2">
        <div class="col-md-4 col-sm-4 col-xl-4">
            <div class="form-group">
                ...
                {{ Form::date('fecha_nacimiento', \Carbon\Carbon::now()->format('Y-m-d'),['class' => 'form-control']) }}
                @error('fecha')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="col-md-4 col-sm-12 col-xl-4">
            <div class="form-group">
                ...
                {!! Form::select('sexo', ['L' => 'Masculino', 'S' => 'Femenino'], null, ['class' => 'form-control']) !!}
                @error('tipo_sexo')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
